...
class UniMiB_Dataset(Dataset):
    def __init__(self, args: argparse, x, x_aug, y, s, mode):
        ...
        if args.dataset_ver == 1:
            ...
            self.users = [1, 2, 3, 5, 7, 8, 9, 10, 11, 13, 14, 15, 16, 18, 19, 21, 22, 25, 26, 27, 29]
            self.target_users = [4, 6, 12, 17, 20, 23, 24, 28, 30]
            ...
            self.users = [3, 4, 6, 7, 8, 9, 11, 13, 14, 16, 18, 19, 20, 22, 23, 24, 25, 26, 27, 28, 29]
            self.target_users = [1, 2, 5, 10, 12, 15, 17, 21, 30]
            ...
            self.users = [2, 3, 4, 6, 7, 10, 11, 13, 14, 16, 17, 19, 20, 22, 23, 25, 26, 27, 28, 29, 30]
            self.target_users = [1, 5, 8, 9, 12, 15, 18, 21, 24]
        elif args.dataset_ver == 9:
            self.users = [2, 3, 4, 5, 6, 7, 8, 10, 12, 14, 15, 17, 18, 19, 20, 21, 22, 23, 25, 26, 28]
            self.target_users = [1, 9, 11, 13, 16, 24, 27, 29, 30]
        elif args.dataset_ver == 10:
            self.users = [1, 2, 4, 5, 6, 8, 9, 11, 12, 14, 16, 17, 18, 19, 20, 21, 23, 24, 25, 27, 29, ]
            self.target_users = [3, 7, 10, 13, 15, 22, 26, 28, 30]
