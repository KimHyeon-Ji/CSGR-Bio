...
class AFDB(object):
    ...
    def __init__(self):
        ...
        self.processed_path = os.path.join(DATA_DIR, 'data')
    ...
    def generate_processed_db(self):
        ...
        with open(os.path.join(self.processed_path, 'x_train_4.pkl'), 'wb') as f:
            pickle.dump(train_data_n, f)
        with open(os.path.join(self.processed_path, 'x_test_4.pkl'), 'wb') as f:
            pickle.dump(test_data_n, f)
        with open(os.path.join(self.processed_path, 'state_train_4.pkl'), 'wb') as f:
